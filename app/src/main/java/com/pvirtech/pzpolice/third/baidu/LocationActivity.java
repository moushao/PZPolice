    ...
    protected void onStart() {
        ...
        startLocation.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (startLocation.getText().toString().equals(getString(com.pvirtech.pzpolice.R.string.startlocation))) {
                    locationService.start();// 定位SDK
                    // start之后会默认发起一次定位请求，开发者无须判断isstart并主动调用request
                    startLocation.setText(getString(com.pvirtech.pzpolice.R.string.stoplocation));
                } else {
