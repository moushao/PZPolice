...
import com.example.sublimepickerlibrary.SublimePicker;
...
// You can also override 'formatDate(Date)' & 'formatTime(Date)'
    ...
    public interface Callback {
        ...
        void onDateTimeRecurrenceSet(SelectedDate selectedDate, int hourOfDay, int minute, SublimeRecurrencePicker.RecurrenceOption
                recurrenceOption, String recurrenceRule);
    }
}
