...
public class TeamAssessmentAdapter extends RecyclerView.Adapter {
    ...
    private List<TeamAssessmentEntity> mData;

    private OnRecyclerViewListener onRecyclerViewListener;


    public TeamAssessmentAdapter(Context context, List<TeamAssessmentEntity> mData, OnRecyclerViewListener onRecyclerViewListener) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_team_assessment, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        holder.iv_icon.setImageResource(mData.get(i).getImageId());
