...
import com.pvirtech.pzpolice.entity.HandleSituationEntity;
...
public class HandleSituationAdapter extends RecyclerView.Adapter {
    ...
    private List<HandleSituationEntity> mData;

    private OnRecyclerViewListener onRecyclerViewListener;


    public HandleSituationAdapter(Context context, List<HandleSituationEntity> mData, OnRecyclerViewListener onRecyclerViewListener) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_handle_situation, null);
