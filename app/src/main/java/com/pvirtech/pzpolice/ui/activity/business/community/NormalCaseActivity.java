...
/**
 * 业绩考核-行政案件办理 - 行政案件  普通案件
 */
public class NormalCaseActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_normal_case);
        initTitleView(title);
        super.onCreate(savedInstanceState);
        mContext = NormalCaseActivity.this;
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                submit(mSelectPicturePath, taskTypeID, task_name, id, tvCaseTime.getText().toString(), CASE_POSITION_NAME,
                                        ...
                                        REMARKS, RESOURCE_ID, userScore,tvCasePoint.getText().toString());
