 ...
 * 挡获盗抢车
 */
public class InvestigationCarRobberyActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_investigation_car_robbery);
        initTitleView(title);
        super.onCreate(savedInstanceState);
        TAG = "InvestigationCarRobberyActivity";
