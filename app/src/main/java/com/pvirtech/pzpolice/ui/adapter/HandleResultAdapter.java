...
import com.pvirtech.pzpolice.entity.HandleResultEntity;
...
public class HandleResultAdapter extends RecyclerView.Adapter {
    ...
    private List<HandleResultEntity> mData;

    private OnRecyclerViewListener onRecyclerViewListener;


    public HandleResultAdapter(Context context, List<HandleResultEntity> mData, OnRecyclerViewListener onRecyclerViewListener) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_handle_result, null);
