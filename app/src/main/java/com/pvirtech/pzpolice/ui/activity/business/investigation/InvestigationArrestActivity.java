...
public class InvestigationArrestActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_investigation_arrest);
        initTitleView(title);
            ...
            case R.id.submit:
              ...
              /*  final String CASE_NAME = edCaseName.getText().toString();
                ...
                if (TextUtils.isEmpty(PERSON_NAME)) {
                    Toasty.warning(mContext, "请输入嫌疑人姓名！").show();
                    return;
                }
