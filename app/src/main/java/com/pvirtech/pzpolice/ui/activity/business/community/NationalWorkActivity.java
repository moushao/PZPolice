 ...
 * 基础工作 ->国保工作
 */
public class NationalWorkActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        setBaseContentView(R.layout.activity_national_work);
        initTitleView(title);
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_task_name:
                if (caseComeType == CaseComeEnum.AUTONOMY.getValue()) {
                    if (ListUtils.isEmpty(taskAndIntegration.getTYPELIST())) {
                        if (caseComeType == CaseComeEnum.TASK.getValue()) {
                            apptaskScoreway();
                        }
                        return;
            ...
            case R.id.submit:
                ...
                final String PERSON_NAME = edPersonName.getText().toString();//当事人姓名
                ...
                final String RESULT = edResult.getText().toString();
                if (TextUtils.isEmpty(RESULT)) {
                    Toasty.warning(mContext, "请输入处置结果！").show();
                    return;
                }
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                submit(mSelectPicturePath, taskTypeID, task_name, id, tvCaseTime.getText().toString(), POSITION_NAME,
                                        MASTER_POLICE_NO, PART_POLICE_NO, REMARKS, RESOURCE_ID, userScore, CASE_NAME, PERSON_NAME, RESULT,tvCasePoint.getText().toString());
                            }
                        }).show();
    ...
    public void submit(final List<String> mSelectPicturePath, String task_type, String task_name, String CASE_TYPE, String CASE_TIME, String
            POSITION_NAME, String MASTER_POLICE_NO, String PART_POLICE_NO, String REMARKS, String RESOURCE_ID, String userScore, String CASE_NAME,
                       String PERSON_NAME, String RESULT,String TOTAL_SCORE) {
