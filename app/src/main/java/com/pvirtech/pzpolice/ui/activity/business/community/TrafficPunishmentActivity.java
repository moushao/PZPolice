 ...
 * 行政案件办理 - 交通案件  主界面
 */
public class TrafficPunishmentActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_traffic_punishment);
        initTitleView(title);
        super.onCreate(savedInstanceState);
        mContext = TrafficPunishmentActivity.this;
...
//            tvCaseType.setText(title);
    ...
    public void submit(final List<String> mSelectPicturePath, String task_type, String task_name, String CASE_TYPE, String CASE_START_TIME, String
            CASE_POSITION_NAME, String CASE_NAME,
                       ...
                       String RESOURCE_ID, String userScore, String CAR_NUMBER, String TOTAL_SCORE) {
    ...
    @OnClick({R.id.ll_case_time, R.id.submit, R.id.ll_car_number, R.id.ll_task_name,})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.submit:
                ...
                final String CASE_POSITION_NAME = edPlace.getText().toString();
               /* if (TextUtils.isEmpty(CASE_POSITION_NAME)) {
                ...
                final String CAR_NUMBER = tvCarNumber.getText().toString();
              ...
              /*  if (ListUtils.isEmpty(listPersons)) {
                ...
                new SweetAlertDialog(this, SweetAlertDialog.NORMAL_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                sweetAlertDialog.dismissWithAnimation();
                                submit(mSelectPicturePath, taskTypeID, task_name, id, tvCaseTime.getText().toString(), CASE_POSITION_NAME, title,
                                        PERSON_NAME,
                                        AppValue
                                                .getInstance().getmUserInfo().getUSER_ID(), strListPersons, getPosition(), REMARKS, RESOURCE_ID,
                                        userScore,
                                        CAR_NUMBER, tvCasePoint.getText().toString());
                            }
                        }).show();
