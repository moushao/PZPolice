...
import static com.pvirtech.pzpolice.R.id.tv_case_time;

/**
 * 接处警  主界面
 */
public class AlarmActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_alarm);
        initTitleView(title);
    ...
    private void initView(int caseComeType) {
        ...
        DictionariesEntity dictionariesEntity1 = new DictionariesEntity("", "现场处置完毕");
        DictionariesEntity dictionariesEntity2 = new DictionariesEntity("", "受案处理");
        DictionariesEntity dictionariesEntity3 = new DictionariesEntity("", "移交处理");
        dictionariesEntityList.add(dictionariesEntity1);
        dictionariesEntityList.add(dictionariesEntity2);
        dictionariesEntityList.add(dictionariesEntity3);
        ...
        switch (view.getId()) {
            ...
            case R.id.submit:
              ...
              /*  if (ListUtils.isEmpty(listPersons)) {
                ...
                Gson gson = new Gson();
                final String userScore = gson.toJson(securityCasePointList);//分值分配
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                submit(mSelectPicturePath, taskTypeID, task_name, id, tvCaseTime.getText().toString(), CASE_POSITION_NAME,
                                        CASE_NAME, PERSON_NAME,
                                        AppValue.getInstance().getmUserInfo().getUSER_ID(), strListPersons, getPosition(), REMARKS, RESOURCE_ID,
                                        userScore, RESULT, tvCasePoint.getText().toString());
