...
import com.pvirtech.licenseplate.mylibrary.InputPlatesActivity;
 ...
 * 挡获踩沙石工具
 */
public class InvestigationSandActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_investigation_sand);
        initTitleView(title);
        super.onCreate(savedInstanceState);
        TAG = "InvestigationPersonActivity";
    ...
    public void submit(final List<String> mSelectPicturePath, String task_type, String task_name, String CASE_TYPE, String CASE_START_TIME, String
        ...
        data.addProperty("RESULT", RESULT);//挡获内容
        if (caseComeType == CaseComeEnum.TASK.getValue()) {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_car_number:
                Intent intent = new Intent(mContext, InputPlatesActivity.class);
                String intentData = tvCarNumber.getText().toString();
            ...
            case R.id.submit:
                ...
                String CASE_POSITION_NAME = edAddress.getText().toString();
              ...
              /*  if (ListUtils.isEmpty(listPersons)) {
                ...
                String RESULT = "机具：" + edMachine.getText().toString();
                if (TextUtils.isEmpty(RESULT) && TextUtils.isEmpty(CAR_NUMBER)) {
                    Toasty.warning(mContext, "请输入挡获内容！").show();
                    return;
                }
