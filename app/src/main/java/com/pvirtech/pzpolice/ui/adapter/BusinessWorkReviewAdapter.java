...
public class BusinessWorkReviewAdapter extends RecyclerView.Adapter {
    ...
    public BusinessWorkReviewAdapter(Context context, List<TaskTrajectory> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout
                .adapter_business_work_review, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        TaskTrajectory vacationDetailsEntity = list.get(i);
    ...
    public void addData(TaskTrajectory entity) {
        list.add(entity);
        notifyDataSetChanged();
    }
}
