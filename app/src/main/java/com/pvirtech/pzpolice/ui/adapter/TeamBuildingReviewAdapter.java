...
public class TeamBuildingReviewAdapter extends RecyclerView.Adapter {
    ...
    private List<DetailTrackEntity.TrailBean> list;

    private OnRecyclerViewListener onRecyclerViewListener;


    public TeamBuildingReviewAdapter(Context context, List<DetailTrackEntity.TrailBean> list, OnRecyclerViewListener onRecyclerViewListener) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_team_building_review, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        DetailTrackEntity.TrailBean trailBean = list.get(i);
    ...
    public List<DetailTrackEntity.TrailBean> getList() {
        return list;
    }

    public void setList(List<DetailTrackEntity.TrailBean> list) {
        this.list = list;
