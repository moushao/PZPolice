...
import com.pvirtech.pzpolice.entity.AlarmClassEntity;
...
public class AlarmClassAdapter extends RecyclerView.Adapter {
    ...
    private List<AlarmClassEntity> mData;

    private OnRecyclerViewListener onRecyclerViewListener;


    public AlarmClassAdapter(Context context, List<AlarmClassEntity> mData, OnRecyclerViewListener onRecyclerViewListener) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_alarm_class, null);
