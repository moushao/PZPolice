 ...
 * 业务考核-其他工作-提供线索破案
 */
public class ProvideCluesActivity extends BaseCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        initData();
        setBaseContentView(R.layout.activity_provide_clues);
        initTitleView(title);
    ...
    @OnClick({R.id.ll_case_type, R.id.ll_case_time, R.id.ll_task_name, R.id.submit, R.id.ll_situation})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_situation:
                dictionariesDialog.showDialog(mContext, "", tvSituation.getText().toString(), dictionariesEntityList, new OnItemSelectedListener() {
                    @Override
                    public void onSelected(DictionariesEntity dictionariesEntity) {
                        tvSituation.setText(dictionariesEntity.getNAME());
                    }
                });
                break;
            ...
            case R.id.submit:
              ...
              /*  if (ListUtils.isEmpty(listPersons)) {
                ...
                final String RESULT = tvSituation.getText().toString();
                if (TextUtils.isEmpty(RESULT)) {
                    Toasty.warning(mContext, "请选择办理情况！").show();
                    return;
                }
